...
// Pop-up (Hide & Show) Managmant 


// let emailPopupInHTML = document.querySelector(".email-popup-wrapper");
// let notifierBtnInHTML = document.querySelector(".email-notifier-btn");

// notifierBtnInHTML.addEventListener("click", function () {

//     emailPopupInHTML.style.display = "block";

// }, false);

const appearTheBox = function () {
    let emailPopupInHTML = document.querySelector(".email-popup-wrapper");
    emailPopupInHTML.style.display = 'block';
};
...
notifierBtnInHTML.addEventListener('click', appearTheBox, false);